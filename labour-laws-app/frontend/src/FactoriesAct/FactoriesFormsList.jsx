...
const factoriesForms = [
    ...
    { id: 4, name: "Form 1 - Application for Permission to Construct/Extend a Factory", file: "",disabled: true },
    { id: 5, name: "Form 2 - Notice of Occupation", file: "",disabled: true },
    { id: 6, name: "Form 3 - Register of Adult Workers", file: "" ,disabled: true},
    { id: 7, name: "Form 4 - Register of Child Workers", file: "" ,disabled: true},
    { id: 8, name: "Form 5 - Certificate of Fitness for Young Workers", file: "",disabled: true },
    { id: 9, name: "Form 10 - Register of Leave with Wages", file: "",disabled: true },
    { id: 10, name: "Form 11 - Health Register", file: "",disabled: true },
